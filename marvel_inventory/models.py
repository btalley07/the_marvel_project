...
class Character(db.Model):
    ...
    def __init__(self,name,description,comics_appeared_in,super_power,user,id =''):
        self.id = self.set_id()
        self.name = name
...
class MarvelSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name', 'description', 'comics appeared in', 'super power', 'date created' ]


marvel_schema = MarvelSchema()
marvel_schemas  = MarvelSchema(many=True)